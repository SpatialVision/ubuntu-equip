...
# Licence: MIT
# to run: wget --no-check-certificate https://github.com/resilva87/ubuntu-equip/raw/master/equip_maven2.sh && bash equip_maven2.sh [latest_version]
...
LINK="http://archive.apache.org/dist/maven/binaries/$FILENAME"
